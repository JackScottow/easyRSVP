...
function LoginContent() {
  ...
  const handleGoogleLogin = async () => {
    if (!supabase) {
      setOauthError("Authentication service is not available. Please refresh the page and try again.");
      return;
    }
    setOauthError(null);
    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <Card className="w-full max-w-md">
        ...
        <div className="px-6 pb-6 flex flex-col gap-2">
          <Button type="button" className="w-full bg-white text-black border border-gray-300 hover:bg-gray-100 flex items-center justify-center gap-2" onClick={handleGoogleLogin} disabled={oauthLoading || !supabase}>
